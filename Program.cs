...
namespace StrongholdApproximator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Logo();
            Console.WriteLine("Input first standing position Y coordinate");
            ...
            Logo();
            Console.WriteLine("Input first hover position Y coordinate");
            ...
            Logo();
            Console.WriteLine("Input second standing position Y coordinate");
            ...
            Logo();
            Console.WriteLine("Input second hover position Y coordinate");
